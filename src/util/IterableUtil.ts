// These functions exist so it is not required to fully copy an iterable to an array
// every time you want to modify the values
 ...
 */
export function* mapIterable<TIn, TOut>(iterable: Iterable<TIn>, callbackFn: (element: TIn, index: number) => TOut,
 ...
 * @param thisArg - Value to use as `this` when executing `callbackFn`.
 */
export function* filterIterable<T>(iterable: Iterable<T>, callbackFn: (element: T, index: number) => boolean,
 ...
 */
export function* concatIterables<T>(iterables: Iterable<Iterable<T>>): Iterable<T> {
 ...
 */
export function reduceIterable<TIn>(iterable: Iterable<TIn>,
 ...
 */
export function reduceIterable<TIn, TOut>(iterable: Iterable<TIn>,
