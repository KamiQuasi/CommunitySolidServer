...
import type { AccessMap, AccessMode } from '../../../src/authorization/permissions/Permissions';
...
describe('An OwnerPermissionReader', (): void => {
  ...
  it('returns empty permissions for non-ACL resources.', async(): Promise<void> => {
    ...
    compareMaps(await reader.handle({ credentials, accessMap }), new IdentifierMap());
  });
